   ...
   test2 : Factures;
    ...
    onSubmit() {
        ...
        if (this.myform.valid) {
            this.addToast({
                title: '',
                msg: 'Votre Facture est en cours',
                timeout: 2000,
                theme: 'bootstrap',
                position: 'top-right',
                type: 'wait'
           ...
           this.factureClientService.addFacture(this.facturePost).subscribe(facturePostconsole => {
                    try {
                        ...
                        this.addToast({
                            title: '',
                            msg: 'Votre Facture est ajouté à votre système',
                            timeout: 2000,
                            theme: 'bootstrap',
                            position: 'top-right',
                            type: 'success'
                        ...
                        this.addToast({
                            title: '',
                            msg: 'Votre Facture n\'est pas ajouté à votre système',
                            timeout: 2000,
                            theme: 'bootstrap',
                            position: 'top-right',
                            type: 'error'
            ...
            this.factureClientService.updateFacture( this.facturePost ).subscribe(facturePostconsole=>{
                    try {
                        ...
                        if(typeof facturePostconsole.RefFacture=='undefined'){
                            this.addToast({title:'', msg:'Votre Facture est modifié à votre système', timeout: 2000, theme:'bootstrap', position:'top-right', type:'success'});
                            this.myform.reset();
                            setTimeout(() => {this.ngOnInit();}, 1000);
                        }
                    }catch (e) {
                        this.addToast({title:'', msg:'Votre Facture n\'est pas modifié à votre système', timeout: 2000, theme:'bootstrap', position:'top-right', type:'error'});
                    }
                    });
        }
    }
    ...
    delete(facture:Factures):void{
        ...
        this.addToast({title:'', msg:'Votre Facture est en cours', timeout: 2000, theme:'bootstrap', position:'top-right', type:'wait'});
        this.factureClientService.deleteFacture(facture).subscribe(produitPostconsole=>{
            ...
            try {
                ...
                if(typeof produitPostconsole.RefFacture =='undefined'){
                    this.addToast({title:'', msg:'Votre Facture est supprimé ', timeout: 2000, theme:'bootstrap', position:'top-right', type:'success'});
                    setTimeout(() => {this.ngOnInit();}, 1000);
                }
            }catch (e) {
                console.log(e);
                this.addToast({title:'', msg:'Votre Facture n\'est pas supprimé à votre système', timeout: 2000, theme:'bootstrap', position:'top-right', type:'error'});
            }
        });
        setTimeout(() => {this.ngOnInit();}, 1000);
    }
    ...
    deleteLigne(ligneFacture:LigneFacture):void{
        ...
        this.addToast({title:'', msg:'Votre Ligne Facture est en cours', timeout: 2000, theme:'bootstrap', position:'top-right', type:'wait'});
        this.factureClientService.deleteLignesFacture(ligneFacture).subscribe(produitPostconsole=>{
            ...
            try {
                if(typeof produitPostconsole.id =='undefined'){
                    ...
                    this.addToast({title:'', msg:'Votre Ligne Facture est supprimé ', timeout: 2000, theme:'bootstrap', position:'top-right', type:'success'});
                ...
                console.log(e);
                this.addToast({title:'', msg:'Votre Ligne Facture  n\'est pas supprimé à votre système', timeout: 2000, theme:'bootstrap', position:'top-right', type:'error'});
            }
        });
        ...
        if (this.myformligne.valid) {
            ...
            this.factureClientService.addLignesFacture( this.ligneFacturePost ).subscribe(factureLignePostconsole=>{
                    try {
                            ...
                            this.addToast({title:'', msg:'Votre Facture est en cours', timeout: 2000, theme:'bootstrap', position:'top-right', type:'success'});
    ...
    addToast(options) {
        ...
        const toastOptions: ToastOptions = {
            ...
            onAdd: (toast: ToastData) => {
                console.log('Toast ' + toast.id + ' est ajouté!');
            },
            onRemove: (toast: ToastData) => {
                console.log('Toast ' + toast.id + ' est supprimé!');
            }
        };
