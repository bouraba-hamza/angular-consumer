...
export class ProductsComponent implements OnInit {
    ...
    @ViewChild('productpush') productpush1: ElementRef;
...
//resize()
  ...
  constructor( private productsService :ProductsService,private ProviderService : ProviderService,private installerService : InstallerService,private CommandesService :CommandesService,private modalService: NgbModal,private http: HttpClient,private toastyService: ToastyService) { }

  ngOnInit() {

    // this.function();

      this.getproductBoitier();
    ...
    BoitierSim(val){
      this.affectOk=val;
      console.log('oolololol');
      console.log(this.affectOk);
    }
    ...
    getproductBoitier():void{

        this.productsService.getproductBoitier().subscribe(product =>this.productdata=product);

        this.result='Imei';
        this.modele='Model';
        this.labelLigne='label';
        this.labelform='Ajout manuel des boitiers';
        this.labelformUpdate ='Modifier Boitier';
         ...
         this.productsService.addSimBoitier( this.productPost ).subscribe(produitPostconsole=>{
                try {
                    if(typeof produitPostconsole!='undefined'){
                        ...
                        f.reset();
                        setTimeout(() => {this.getproductBoitier();this.ngOnInit();}, 1000);
                    }
      ...
      console.log(f.value);
        ...
        this.productsService.activer( this.produtcUpdate ).subscribe(produitPostconsole=>{
                try {
                    ...
                    setTimeout(() => {this.ngOnInit(); this.getproductBoitier()}, 1000);
                }catch (e) {
