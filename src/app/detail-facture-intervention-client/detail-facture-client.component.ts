            ...
            this.detailFactureProviderService.addReglement( this.reglementPost ).subscribe(reglementPostconsole=>{
                    ...
                    try {
                        if(typeof reglementPostconsole.Montant!='undefined'){
                            ...
                            this.addToast({title:'', msg:'', timeout: 2000, theme:'bootstrap', position:'top-right', type:'success'});
                            this.myform.reset();
                            setTimeout(() => {this.ngOnInit();}, 1000);
                        }
                    }catch (e) {
                        this.addToast({title:'', msg:'', timeout: 2000, theme:'bootstrap', position:'top-right', type:'error'});
                    }
