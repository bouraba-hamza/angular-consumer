 ...
 */
export declare class DxSwitchComponent extends DxComponent implements OnDestroy, OnInit, AfterViewInit, ControlValueAccessor {
    instance: DxSwitch;
    ...
    /**
     * A handler for the switchedOffTextChange event.
     */
    switchedOffTextChange: EventEmitter<string>;
    /**
     * A handler for the switchedOnTextChange event.
     */
