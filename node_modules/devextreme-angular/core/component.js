...
exports.IS_PLATFORM_SERVER = platform_browser_2.makeStateKey('DX_isPlatformServer');
var DxComponent = (function () {
    ...
    DxComponent.prototype._initEvents = function () {
        ...
        this.instance.on('optionChanged', function (e) {
            ...
            _this.eventHelper.fireNgEvent(e.name + 'Change', [e.component.option(e.name)]);
    ...
    DxComponent.prototype._destroyWidget = function () {
        if (this.instance) {
            ...
            platform_browser_1.ɵgetDOM().remove(element);
        }
    };
